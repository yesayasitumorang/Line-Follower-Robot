  ...
  if (s1 == HIGH && s2 == HIGH && s3 == HIGH && s4 == HIGH && s5 == HIGH) {
    ...
    switch(rintangan) {
      ...
      case 4://simpang 2 (ambil pohon dan belok kiri)
        ...
        digitalWrite(MOTOR_A_DIR, HIGH);
        digitalWrite(MOTOR_B_DIR, HIGH);
        analogWrite(MOTOR_A_SPEED, 200);  // Kecepatan belok maju
        analogWrite(MOTOR_B_SPEED, 200);  // Kecepatan belok maju
        delay(1000);
        ...
        break;
      case 8://simpang 3 (belok kanan & taruh object)
        digitalWrite(MOTOR_A_DIR, HIGH);   
        digitalWrite(MOTOR_B_DIR, HIGH);
        analogWrite(MOTOR_A_SPEED, 0);  // Kecepatan belok maju
        analogWrite(MOTOR_B_SPEED, 0);  // Kecepatan belok maju
    ...
    if (!flag) {
     ...
     switch(rintangan) {
      case 5://belok kanan 1
        ...
        digitalWrite(MOTOR_B_DIR, HIGH);
        analogWrite(MOTOR_A_SPEED, 255);  // Kecepatan belok maju
        analogWrite(MOTOR_B_SPEED, 100);  // Kecepatan belok maju
        delay(600);
        break;
     }
    ...
    if (!flag) {
     ...
     switch(rintangan) {
      case 6://kiri 1
        ...
        digitalWrite(MOTOR_A_DIR, HIGH);
        digitalWrite(MOTOR_B_DIR, HIGH);
        analogWrite(MOTOR_A_SPEED, 100);  // Kecepatan belok maju
        analogWrite(MOTOR_B_SPEED, 255);  // Kecepatan belok maju
        delay(1000);
        break;
      case 10://kiri 2
